...
CREATE TABLE IF NOT EXISTS `seid`.`productos` (
  ...
  `codigo_barras_producto` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `seid`.`incidencias` (
  ...
  `status_incidencia` ENUM('pendiente', 'resuelta') NOT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `seid`.`egresos` (
  ...
  PRIMARY KEY (`id_egresos`, `descripcion_egreso`),
