                ...
                <form action="<?=HTTP_URL?>auth/login-qr.php" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-qr-buttons">
                            ...
                            <input
                                ...
                                id="qr_code"
                                name="qr_code"
                                placeholder="Escanee, suba o ingrese su código QR"
                                value="<?=$_SESSION['olds']['qr'] ?? ''?>"
                            >
                            ...
                            <!-- ACTIVAR CAMARA PARA ESCANEO -->
                            <button type="button" id="active-scan-qr">
                    ...
                    <fieldset>
                        ...
                        <input
                            ...
                            id="token"
                            name="token"
                            placeholder="Ingrese su token de seguridad de 4 digitos"
                            title="El token debe contener exactamente 4 dígitos."
                            value="<?=$_SESSION['olds']['token'] ?? ''?>"
                        >
                    </fieldset>
