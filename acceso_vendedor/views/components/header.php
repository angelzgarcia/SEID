        ...
        <div class="nav-links-container">
            <div class="nav-links">
                <ul class="nav-links-list">
                    <li>
                        <a
                            href="<?= SELLER_HTTP_VIEWS ?>dashboard"
                            class="<?= strpos($_SERVER['PHP_SELF'], 'dashboard.php') ? 'active' : '' ?>"
                        >
                    ...
                    <li>
                        <a
                            href=""
                            class="<?= strpos($_SERVER['PHP_SELF'], 'notificaciones/create.php') ? 'active' : '' ?>"
                        >
                    ...
                    <li>
                        <a
                            href=""
                            class="<?= strpos($_SERVER['PHP_SELF'], 'ajustes/create.php') ? 'active' : ''
                        ?>">
