        ...
        <div class="sidebar-links-container">
            <div class="sidebar-links">
                <ul class="sidebar-links-list">
                    ...
                    <!-- SUCURSALES -->
                    <li>
                        <a href="<?= MATRIX_HTTP_VIEWS ?>sucursales/index" class="<?= strpos($_SERVER['PHP_SELF'], 'sucursales/') ? 'active' : '' ?>">
                    ...
                    <!-- USUARIOS -->
                    <li>
                        <a href="<?= MATRIX_HTTP_VIEWS ?>credenciales/index" class="<?= strpos($_SERVER['PHP_SELF'], 'credenciales/') ? 'active' : '' ?>">
                    ...
                    <!-- EGRESOS -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'egresos/') ? 'active' : '' ?>">
                    ...
                    <!-- INCIDENCIAS -->
                    <li>
                        <a href="<?= MATRIX_HTTP_VIEWS ?>incidencias/index" class="<?= strpos($_SERVER['PHP_SELF'], 'incidencias/') ? 'active' : '' ?>">
                    ...
                    <!-- REPORTES -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'reportes/create.php') ? 'active' : '' ?>">
                    ...
                    <!-- PROVEEDORES -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'proveedores/create.php') ? 'active' : '' ?>">
