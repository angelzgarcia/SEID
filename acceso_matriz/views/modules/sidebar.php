        ...
        <div class="sidebar-links-container">
            <div class="sidebar-links">
                <ul class="sidebar-links-list">
                    ...
                    <!-- SUCURSALES -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'sucursales/create.php') ? 'active' : '' ?>">
                    ...
                    <!-- USUARIOS -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'usuarios/create.php') ? 'active' : '' ?>">
                    ...
                    <!-- EGRESOS -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'egresos/create.php') ? 'active' : '' ?>">
                    ...
                    <!-- INCIDENCIAS -->
                    <li>
                        <a href="" class="<?= strpos($_SERVER['PHP_SELF'], 'incidencias/create.php') ? 'active' : '' ?>">
