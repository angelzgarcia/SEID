                    ...
                    <?php foreach($categorias as $categoria): ?>
                        ...
                        <div class="register-frame category-frame">
                            ...
                            <div href="" class="register-details-link category-details-link">
                                ...
                                <p>
                                    Status:
                                    <span><?= (int)$categoria['status_categoria'] === 1 ? 'Activa' : 'Inactiva'; ?></span>
                                </p>
                            </div>

                            <!-- ACCIONES -->
                            <div class="register-actions">
                                <a href="./edit?c=<?= encryptValue($categoria['id_categoria'], SECRETKEY) ?>">
                                ...
                                <form action="<?= MATRIX_HTTP_URL ?>functions/crud_categoria?c=<?= encryptValue($categoria['id_categoria'], SECRETKEY) ?>" class="destroy-btn" id="destroy-btn" method="POST">
                                    <input type="hidden" name="accion" value="modificar">

                                    <button type="button" data-form="destroy-btn" data-title="Cambiar status">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
