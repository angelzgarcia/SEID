        ...
        <div class="content-modal">
            <form action="" autocomplete="off" method="POST">
                ...
                <div class="grid-list" id="grid-list">
                    <!-- <div class="shipping-product-card">
                        <div class="product-details">
                            <p>Nombre del producto Nombre del producto Nombre del producto Nombre del producto</p>
                            <span>15 paquetes</span>
                        </div>

                        <div class="actions-btns">
                            <button type="button" title="Descontar producto">
                            ...
                            <button type="button" title="Añadir producto">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
                            </button>

                            <button type="button" title="Quitar producto">
