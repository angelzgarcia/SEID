        ...
        <div class="content-modal">
            <div class="register-details-modal-container">
                ...
                <div class="register-fact">
                    ...
                    <p class="codigo_barras_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="unidad_compra_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="unidad_venta_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="precio_costo_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="precio_venta_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="precio_mayoreo_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    <span>
                        ...
                        Cantidad mínima aplicable a mayoreo:
                    </span>
                    <p class="cantidad_minima_mayoreo_producto"></p>
                </div>
                ...
                <div class="register-fact">
                    ...
                    <p class="status_ubicacion_producto"></p>
                </div>
                ...
                <div class="register-fact regiser-fact-lotes">
                    <span>
                ...
                <div class="register-fact register-fact-image">
                    <span>
                ...
                <div class="register-fact images-history">
                    <details>
                        <summary>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M480-120q-138 0-240.5-91.5T122-440h82q14 104 92.5 172T480-200q117 0 198.5-81.5T760-480q0-117-81.5-198.5T480-760q-69 0-129 32t-101 88h110v80H120v-240h80v94q51-64 124.5-99T480-840q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-480q0 75-28.5 140.5t-77 114q-48.5 48.5-114 77T480-120Zm112-192L440-464v-216h80v184l128 128-56 56Z"/></svg>
                            <div>
                                Historial de imagenes <strong><small>(last 3rd)</small></strong>
                            </div>
                        </summary>

                        <div class="images-history-grid">
                        </div>
                    </details>
                </div>
            </div>
