            ...
            <div class="crud-header">
                ...
                <div class="crud-middle-header">
                    ...
                    <div class="details">
                        <div class="summary">
                            <p>Marcas activas</p>
                            <span><?= $count_marcas_activas ?? 0 ?></span>
                        </div>
                    </div>
                    ...
                    <div class="details">
                        <div class="summary">
                            ...
                            <span><?= $count_marcas_inactivas ?? 0 ?></span>
                        </div>
                    </div>
                    ...
                    <?php foreach($marcas as $marca): ?>
                        ...
                        <div class="register-frame category-frame">
                            ...
                            <div href="" class="register-details-link category-details-link">
                                ...
                                <p>
                                    Descripción:
                                    <span><?= $marca['descripcion_marca'] ?></span>
                                </p>
                                <p>
                                    Status:
                                    <span><?= $marca['status_marca'] === 1 ? 'Activa' : 'Inactiva'; ?></span>
                                </p>
                            </div>
                            ...
                            <div class="register-actions">
                                ...
                                <form action="<?= MATRIX_HTTP_URL ?>functions/crud_marca?m=<?=$m?>" class="status-btn <?= $status === 0 ? 'inactive-btn' : 'active-btn' ?>" data-id="<?=$m?>" method="POST">
