...
if ($busqueda) {
    $monditions[] = "(nombre_sucursal LIKE ? OR direccion_sucursal LIKE ?)";
...
$orden = match ($orden) {
    'recientes' => 'id_sucursal DESC',
    'antiguas' => 'id_sucursal ASC',
    'az' => 'nombre_sucursal ASC',
    'za' => 'nombre_sucursal DESC',
    default => 'id_sucursal DESC'
};

$sql .= " ORDER BY $orden LIMIT 14";

$sucursales = simpleQuery($sql, $params, $types, true) ?: [];


if ($busqueda && empty($sucursales)): ?>
...
<?php elseif (!$busqueda && empty($sucursales)): ?>
    ...
    <div class="registers-empty">
        ...
        <p>AÚN NO HAY SUCURSALES REGISTRADAS.</p>
    </div>
    ...
    foreach ($sucursales as $sucursal): ?>
        ...
        <div class="register-frame category-frame">
            ...
            <div
                ...
                data-id="<?= encryptValue($sucursal['id_sucursal'], SECRETKEY) ?>"
            >
                <div class="register-details">
                    <div class="header-register">
                        <p>
                            <span><?= ucfirst($sucursal['nombre_sucursal']) ?></span>
                        </p>
                    </div>

                    <div class="body-register category-body-register">
                        <img src="<?= $sucursal['imagen_sucursal'] ?? HTTP_URL . 'imgs_denedig/office.png' ?>" alt="brand image" loading="lazy">

                        <div class="quantities">
                            <p>
                                Dirección:
                                <span><?= ucfirst($sucursal['direccion_sucursal']) ?></span>
                            </p>
                            ...
                            <p>
                                Añadida el:
                                <span><?= (int)$sucursal['status_sucursal'] === 0 ? 'Activa' : 'Inactiva'; ?></span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <?php $m = encryptValue($sucursal['id_sucursal'], SECRETKEY) ?>
            <?php $status = (int)$sucursal['status_sucursal'] ?>
