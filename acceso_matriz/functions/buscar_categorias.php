...
if ($busqueda) {
    $conditions[] = "(nombre_categoria LIKE ? OR descripcion_categoria LIKE ?)";
...
$orden = match ($orden) {
    'recientes' => 'id_categoria DESC',
    'antiguas' => 'id_categoria ASC',
    'az' => 'nombre_categoria ASC',
    'za' => 'nombre_categoria DESC',
    default => 'id_categoria DESC'
};

$sql .= " ORDER BY $orden LIMIT 14";

$categorias = simpleQuery($sql, $params, $types, true) ?: [];


if ($busqueda && empty($categorias)): ?>
...
<?php elseif (!$busqueda && empty($categorias)): ?>
    ...
    <div class="registers-empty">
        ...
        <p>AÚN NO HAY CATEGORIAS REGISTRADOS.</p>
    </div>
    ...
    foreach ($categorias as $categoria): ?>
        ...
        <div class="register-frame category-frame">
            ...
            <div
                ...
                data-id="<?= encryptValue($categoria['id_categoria'], SECRETKEY) ?>"
            >
                <div class="register-details">
                    ...
                    <div class="body-register category-body-register">
                        <img src="<?= $categoria['imagen_categoria'] ?: 'https://cdn-icons-png.flaticon.com/512/1440/1440523.png' ?>" alt="product image" loading="lazy">
